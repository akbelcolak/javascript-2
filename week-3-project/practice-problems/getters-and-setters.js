    ...
    const obj2 = {
      ...
      set currentEntry(key){
        if (this.entries.hasOwnProperty(key)){
          ...
          [key]: new Error (`no entry with key "${key}"`)
        }}
      }
    }
